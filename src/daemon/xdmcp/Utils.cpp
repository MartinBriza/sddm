...
namespace XDMCP {
    ...
    Reader::Reader(const QByteArray& data): m_data(data), m_stream(&m_data, QIODevice::ReadOnly | QIODevice::Unbuffered)
    {
    ...
    Writer::Writer(): m_data(), m_stream(&m_data, QIODevice::WriteOnly | QIODevice::Unbuffered)
    {
        m_stream.setByteOrder(QDataStream::BigEndian);
    }
